...
var signIn = function signIn(provider) {
  ...
  return new Promise(function () {
    var _ref9 = _asyncToGenerator(function* (resolve, reject) {
      ...
      if (!provider || !providers[provider]) {
        resolve("".concat(baseUrl, "/signin?callbackUrl=").concat(encodeURIComponent(callbackUrl)));
      } else {
        ...
        var url = data.url ? data.url : callbackUrl;
...
var _fetchData = function () {
  ...
  return function _fetchData(_x8) {
